...
// Planet data
const planetData = [
    { name: 'Mercury', color: 0x8B8B8B, size: 0.4, orbitRadius: 5, speed: 1 },
    { name: 'Venus', color: 0xE6C229, size: 0.6, orbitRadius: 7, speed: 0.8 },
    { name: 'Earth', color: 0x6B93D6, size: 0.6, orbitRadius: 9, speed: 0.7 },
    { name: 'Mars', color: 0x993D00, size: 0.5, orbitRadius: 11, speed: 0.6 },
    { name: 'Jupiter', color: 0xB07F35, size: 1.2, orbitRadius: 14, speed: 0.4 },
    { name: 'Saturn', color: 0xE5DCDC, size: 1.0, orbitRadius: 17, speed: 0.3, hasRing: true },
    { name: 'Uranus', color: 0xD1E7E7, size: 0.8, orbitRadius: 20, speed: 0.2 },
    { name: 'Neptune', color: 0x3E66F9, size: 0.8, orbitRadius: 23, speed: 0.1 }
];
...
function animate() {
    ...
    if (!isPaused) {
        ...
        planets.forEach(planet => {
            planet.angle += planet.speed * delta * 0.5;
